...
sns.relplot(x= "horsepower", data= mpg,y= "mpg", size= "cylinders", kind= "scatter", hue= "cylinders")
...
sns.relplot(data= mpg, kind= "scatter", x= "acceleration", y= "mpg", style= "origin", hue= "origin")
